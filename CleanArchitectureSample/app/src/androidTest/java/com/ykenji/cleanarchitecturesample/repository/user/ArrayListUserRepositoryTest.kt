...
import com.ykenji.cleanarchitecturesample.infrastructure.datasource.arraylist.repository.user.ArrayListUserRepository
import dagger.Binds
...
@HiltAndroidTest
class ArrayListUserRepositoryTest {
    ...
    abstract class TestUserRepositoryModule {
        ...
        @Singleton
        @Binds
        abstract fun bindUserRepository(impl: ArrayListUserRepository): UserRepository
    }

    @Inject
    lateinit var userRepository: ArrayListUserRepository
