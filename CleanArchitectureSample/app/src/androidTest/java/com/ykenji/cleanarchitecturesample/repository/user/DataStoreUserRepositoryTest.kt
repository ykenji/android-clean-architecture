...
import com.ykenji.cleanarchitecturesample.infrastructure.datasource.datastore.repository.user.DataStoreUserRepository
import dagger.Binds
...
class DataStoreUserRepositoryTest {
    ...
    @Inject
    lateinit var userRepository: DataStoreUserRepository
